...
def obtain_plot_aapl_prices_dataframe(start_date, end_date):
  print("Downloading and plotting AAPL log returns...") 
  aapl = pdr.get_data_yahoo("AAPL", start_date, end_date) 
  aapl["returns"] = aapl["Adj Close"]/aapl["Adj Close"].shift(1) 
...
if __name__ == "__main__":
  ...
  aapl_df = obtain_plot_aapl_prices_dataframe(start_date, end_date)
  log_returns = np.array(aapl_df["log_returns"])
